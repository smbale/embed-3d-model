(function () {
    tinymce.PluginManager.requireLangPack("lao3d_personal_edition"); tinymce.create("tinymce.plugins.Lao3dPersonalEdition", { init: function (a, b) {
        a.addCommand("lao3dPersonal", function () { a.windowManager.open({ file: b + "/dialog.php", width: 620 + a.getLang("lao3d_personal_edition.delta_width", 0), height: 300 + a.getLang("lao3d_personal_edition.delta_height", 0), inline: 1 }, { plugin_url: b, some_custom_arg: "custom arg" }) }); a.addButton("lao3d_personal_edition", { title: "lao3d_personal_edition.desc", cmd: "lao3dPersonal",
